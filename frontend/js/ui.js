        ...
        <div class="col-12 col-sm-6 col-lg-4">
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body d-flex flex-columns">
                    ...
                    <button class="btn btn-primary mt-auto" data-add="${p.id}">
                        Agregar al Carrito
                    </button>
                </div>
            </div>
    ...
    cartItemsEl.innerHTML = cart.map(i => 
        ...
        <div class="border rounded-3 p-2 bg-white d-flex gap-2 align-items-center">
            ...
            <div class="d-flex align-items-center gap-2">
                <input class="form-control form-control-sm" style="width:72px" type="number" min="1" value="${i.qty}" data-qty="${i.id}">
